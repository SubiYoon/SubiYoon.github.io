...
## 진행 조건
다음 예시는 k8s-cluster1의 ceph PV 데이터를  k8s-clster2의 ceph 에 미러링하기 위한 방법입니다.
...
csi:
  nfs:
    enabled: true
  # VolumeResplication을 사용하기 위해 Addon sidecar 사용여부 설정
  csiAddons:
    enabled: true
  enableOMAPGenerator: true
  # HostNetwork 사용 여부 설정
  enableCSIHostNetwork: true
  # Repliation Policy를 설정
  enableCSIVolumeReplication: true
