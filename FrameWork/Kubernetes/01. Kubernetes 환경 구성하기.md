...
sudo kubeadm init --pod-network-cidr=20.13.0.0/16 --apiserver-advertise-address 192.168.137.100
```
### Kubernetes 환경설정
```bash
mkdir -p $HOME/.kube
...
kubeadm join 192.168.137.110:6443 --token n0vg2n.qrt10pnw174k1ibl \
