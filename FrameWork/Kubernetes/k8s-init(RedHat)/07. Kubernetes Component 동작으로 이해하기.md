...
![[스크린샷 2025-03-11 오후 1.34.49.png]]
...
**주의해야 할것은 아직 데이터베이스에 데이터가 생성된 것이지 아직 `Pod`가 생성된 것은 아닙니다!!**

### 4. kube-scheduler
`kube-scheduler`는 보통 `kube-apiserver`에 의해 노드들의 자원을 모니터링하고 있다가 데이터베이스에 띄울 `Pod`가 있다면 스케쥴링 해줍니다.
...
![[스크린샷 2025-03-11 오후 2.25.00.png]]
...
![[스크린샷 2025-03-11 오후 2.32.48.png]]
...
![[스크린샷 2025-03-11 오후 2.38.27.png]]
...
![[스크린샷 2025-03-11 오후 2.45.08.png]]
